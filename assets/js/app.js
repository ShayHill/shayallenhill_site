(function ($) {
  ...
  $(document).ready(function(){
    ...
    $(".loadmore-cat, .loadmore-tag, .loadmore-au, .loadmore-h").on("click", function(e){
      e.preventDefault();
      $(".nf-post-item:hidden").slice(0, 10).slideDown();
      if($(".nf-post-item:hidden").length == 0) {
        $(".loadmore-cat, .loadmore-tag, .loadmore-au, .loadmore-h").text("No More Posts").addClass("noContent");
      }
    });
